...
public class ViewModelFactory implements ViewModelProvider.Factory {
    ...
    public ViewModelFactory(SignInUseCase signInUseCase, SaveAttemptUseCase saveAttemptUseCase) {
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        if (modelClass.isAssignableFrom(SignInViewModel.class)) {
            return (T) new SignInViewModel(signInUseCase, saveAttemptUseCase);
        }
